...
train_dataset   = [25]*4      # % of data points used for training model
testing_dataset = [70]*4       # % of data ponts for testing model
#-------------------------------------------------------------------------------#
#----------------- Augmented dimentions for NN prediction ----------------------#
ini_values = [2.5,   0]      # Initial values for each input dimension
fin_values = [50.1, 91]      # Final values for each input dimension
step_sizes = [0.1,   5]      # Step sizes for each input dimension
#################################################################################
...
#-------------------------------------------------------------------------------#
file_name = 'PES_cm.dat'   # input file name for PES file
