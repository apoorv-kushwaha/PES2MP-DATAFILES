...
RR1_atoms        = ['C','C','C','C'] # Enter rigid rotor (RR1) atoms from one end
RR1_bond_len     = [1.3135,1.2938,1.3135]  # Enter bond lengths from the same end (see manual)
...
theta  = [0, 91, 5]    # python loop will run from 0 to 90 with step size of 30
