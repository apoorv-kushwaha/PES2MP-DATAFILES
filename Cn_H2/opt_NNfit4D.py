...
ini_values = [2.5,   0,   0,   0]      # Initial values for each input dimension
fin_values = [50.1, 91,  91, 181]      # Final values for each input dimension
step_sizes = [0.1,  30,  30,  30]      # Step sizes for each input dimension
#################################################################################
...
NN_hyperpara = {
    ...
    'maxit_base'  :    50000,          # max iterations: base model (500-5000)
    'maxit_ensemble' : 50000           # max iterations: ensemble model (5-10K)
}
...
early_stop_para =  {
    ...
    'patience_step_en'       :  5   # 10% of max iterations: ensemble
}
...
#-------------------------------------------------------------------------------#
file_name = 'PES_cm_or.dat'   # input file name for PES file
