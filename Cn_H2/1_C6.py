...
RR1_atoms        = ['C','C','C','C','C','C'] # Enter rigid rotor (RR1) atoms from one end
RR1_bond_len     = [1.3049,1.2905,1.278,1.2905,1.3049]  # Enter bond lengths from the same end (see manual)
