...
RR1_bond_len     = [1.0648,1.2276,1.3392,1.2727,1.3176]  # Enter bond lengths from the same end (see manual)
...
Multiplicity     = [2, 1, 2] # multiplicity of [atom 1, atom 2, whole system]
#------------------------------------------------------------------------------#
# Psi4 parameters (memory, processor, method, basis etc.) ---------------------#
psi4_mem           = '10 GB'             # total memory
psi4_proc          = 10                  # number of processors(doesn't scale)
...
#R_i   = [6.0] # initial R in Ang. (eg. 0.1 Ang.)
#R_f   = [6.5] # final R - R_stp (eg 1.95 Ang.)
#R_stp = [0.1] # step size for R_i-R_f
