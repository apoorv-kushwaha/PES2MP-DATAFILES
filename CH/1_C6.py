...
RR1_atoms        = ['H','C','C','C','C','C','C'] # Enter rigid rotor (RR1) atoms from one end
RR1_bond_len     = [1.0648,1.2210,1.3535,1.2415,1.3267,1.2994]  # Enter bond lengths from the same end (see manual)
