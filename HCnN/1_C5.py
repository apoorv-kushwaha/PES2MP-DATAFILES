...
RR1_atoms        = ['H','C','C','C','C','C','N'] # Enter rigid rotor (RR1) atoms from one end
RR1_bond_len     = [1.057,1.209,1.362,1.222,1.364,1.161]  # Enter bond lengths from the same end (see manual)
