...
RR1_atoms        = ['H','C','C','C','C','C','C','N'] # Enter rigid rotor (RR1) atoms from one end
RR1_bond_len     = [1.062,1.227,1.314,1.276,1.260,1.333,1.171]  # Enter bond lengths from the same end (see manual)
