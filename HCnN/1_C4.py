...
RR1_atoms        = ['H','C','C','C','C','N'] # Enter rigid rotor (RR1) atoms from one end
RR1_bond_len     = [1.059,1.249,1.285,1.332,1.180]  # Enter bond lengths from the same end (see manual)
